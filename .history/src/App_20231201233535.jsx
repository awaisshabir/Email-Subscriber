  ...
  return (
    ...
    <div className="flex items-center justify-center h-screen bg-[#3F3F46]">
      <div className='bg-[#24242A] p-2 mx-6 rounded-2xl'>
        ...
        <img src='../src/assets/images/image.jpg' alt='' className='object-fit rounded-xl h-80 md:h-64 md:rounded-l-xl md:rounded-r-none transform hover:scale-105 hover:rounded-xl duration-200'/>
