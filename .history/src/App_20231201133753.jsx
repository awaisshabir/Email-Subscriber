      ...
      <div className='bg-[#24242A] p-2 mx-6 rounded-2xl'>
        ...
        <div className='p-6 md:p-12'>
          ...
          <div className='flex flex-col mt-5 space-y-4 md:space-x-3 md:flex-row md:space-y-0'>
            ...
            className='p-2 px-4 text-center text-white bg-zinc-800 border border-zinc-600 placeholder:text-center placeholder:text-xs md:text-left placeholder:md:text-left'
            />
          </div>
        </div>
        </div>
